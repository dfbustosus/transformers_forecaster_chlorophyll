...
def reviewer_rows() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "risk_level": "medium",
            "code_owner_agent": "visualization-engineer",
            "required_artifact": "End-to-end methodology workflow integrated into the rebuilt Figure 2.",
            "output_path": "figures/figure_02_preprocessing_workflow.mmd; figures/figure_02_preprocessing_workflow.svg; figures/figure_02_preprocessing_workflow.png",
            "test_path": "Mermaid render via npm run render:figure02 or scripts/recreate_figures.py",
            "manuscript_section": "Figure 2; Methods overview text",
            "proposed_response": "The rebuilt Figure 2 now provides the end-to-end reproducible workflow from raw station workbooks through provenance, daily target construction, gap-aware reconstruction, foundation-model forecasting, diagnostics, and reviewer-evidence outputs. Separate satellite-inversion details remain author-input/claim-reduction items until matchup data are supplied.",
            "status": "generated_as_integrated_figure_2_workflow_satellite_details_need_input",
            "needs_author_input": "Provide satellite acquisition/inversion details if Figure 2 must depict validated satellite feature ingestion rather than station-data forecasting inputs.",
        },
    ]
