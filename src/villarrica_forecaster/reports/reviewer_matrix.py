...
def reviewer_rows() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "proposed_response": "Each modeled daily value now carries observed, interpolated, imputed, outlier, and smoothing flags; proportions are reported by station. A separate 2024 observed-preserving, no-smoothing imputation validation artifact is generated before any forecast rerun.",
        ...
        },
        {
            ...
            "proposed_response": "We computed ±14-day lagged correlations, peak-date error, and event-onset error for the cached TimesFM and Chronos Large rolling-origin predictions.",
        ...
        },
        {
            ...
            "proposed_response": "We generated observed-target and all-target binary-warning metrics for cached TimesFM and Chronos Large predictions, including confusion-matrix counts and POD/TNR/precision/F1/false-alarm/miss-rate fields.",
            "status": "generated_from_foundation_predictions",
            "needs_author_input": "Confirm final management threshold wording and whether additional non-Chl-a thresholds should be included.",
        },
        {
            "reviewer": "Reviewer 3",
            "comment_id": "R3.2",
        ...
        },
        {
            ...
            "proposed_response": "We expose imputation flags and generated observed-only plus gap-stratified scoring tables for cached TimesFM and Chronos Large predictions.",
            "status": "generated_from_foundation_predictions",
        ...
        },
        {
            ...
            "proposed_response": "The pipeline evaluates cached TimesFM/Chronos q10/q50/q90 interval coverage and no longer fabricates uncertainty bounds in strict manuscript mode.",
        ...
        },
        {
            ...
            "required_artifact": "Professional preprocessing workflow figure with source table and rendered manuscript exports.",
            "output_path": "outputs/tables/figure_02_preprocessing_workflow_source.csv; figures/figure_02_preprocessing_workflow.svg; figures/figure_02_preprocessing_workflow.png",
            "test_path": "Python figure render via npm run render:figure02 or scripts/recreate_figures.py",
            "manuscript_section": "Figure 2",
            "proposed_response": "We rebuilt Figure 2 as a version-controlled, source-table-backed workflow diagram and rendered it to readable vector/raster manuscript exports.",
            "status": "generated",
        ...
        },
        {
            ...
            "output_path": "figures/figure_methodology_end_to_end.png",
